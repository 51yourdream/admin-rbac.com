...
final class FileTool {
    ...
    public static $extentsionImageMap = array(
        'jpe' => 'image/jpeg',
        'jpeg' => 'image/jpeg',
        'jpg' => 'application/x-jpg',
        'gif' => 'image/gif',
    ...
    public static $extentsionFileMap = array(
        "docx"=> "application/vnd.openxmlformats-officedocument.wordprocessingml.document",
        "xlsx"=> "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet",
        'doc' => 'application/msword',//application/msword
        'pdf' => 'application/pdf',
    ...
    /**
     * 根据扩展名获取Http头ContentType
     *
     * @param string $extension
     * @return string
     */
    public static function getContentTypeFromExtension($extension) {
        return self::$extension2ContentTypeMap[$extension] ? self::$extension2ContentTypeMap[$extension] : self::$extension2ContentTypeMap['*'];
    }
}