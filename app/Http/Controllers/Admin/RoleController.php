...
class RoleController extends BaseController
{
    ...
    public function permissions($id)
    {
        ...
        return view('admin.rbac.roles.permissions_new', compact('role', 'permissions', 'rolePermissions'));
    }
    ...
    public function storePermissions($id, Request $request)
    {
        ...
        return response()->json($result ? ['status' => 1,'msg'=>'权限分配成功!'] : ['status' => 0,'msg'=>'权限分配失败!']);
    }
}
